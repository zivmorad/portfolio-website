...
const AboutMeContent=()=>{
    return(
        <div className='about-me-contianer'>
            ...
            <br/>
            <p className='about-me-content'>I'm interested in the entire front-end spectrum and working on ambitious projects with positive people.
                I'm eager to learn Back-End Development and am looking forward to be a Full Stack Web Developer.
                My goal is to leave every bit of code I touch more readable, modular, performant and accessible than i found it.
            </p>
    </div>
    )
}
